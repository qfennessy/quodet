...
Console output remains the default. For agent feedback, install Quodet as a
tool so its hook commands have stable absolute paths, then initialize an
explicit, versioned Codex route:
